import { checkCollision } from './formula';
import { gameHeight } from './constant';
import {CannonBallType, FlyingObjectType, ObjectsDestroyedType} from "./types";

export const checkCollisions = (cannonBalls: CannonBallType[], flyingDiscs: FlyingObjectType[]) => {
    const objectsDestroyed = [] as ObjectsDestroyedType[];
